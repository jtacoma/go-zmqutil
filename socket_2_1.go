...
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc3)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc4)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc5)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc6)
//
...
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc7)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc8)
//
...
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc9)
//
...
//  Applicable socket types   all, when using multicast transports
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc10)
//
...
//  Applicable socket types   all, when using multicast transports
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc11)
//
...
//  Applicable socket types   all, when using multicast transports
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc12)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc13)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc14)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc15)
//
...
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc16)
//
...
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc17)
//
...
//  Applicable socket types   all, only for connection-oriented transports
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc18)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-getsockopt#toc20)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc3)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc4)
//
...
//  Applicable socket types   N/A
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc5)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc6)
//
...
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc7)
//
...
//  Applicable socket types   ZMQ_SUB
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc8)
//
...
//  Applicable socket types   all, when using multicast transports
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc9)
//
...
//  Applicable socket types   all, when using multicast transports
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc10)
//
...
//  Applicable socket types   all, when using multicast transports
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc11)
//
...
//  Applicable socket types   all, when using multicast transports
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc12)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc13)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc14)
//
...
//  Applicable socket types   all
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc15)
//
...
//  Applicable socket types   all, only for connection-oriented transports
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc16)
//
...
//  Applicable socket types   all, only for connection-oriented transports
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc17)
//
...
//  Applicable socket types   all, only for connection-oriented transports.
//
// (from http://api.zeromq.org/2-1:zmq-setsockopt#toc18)
//
